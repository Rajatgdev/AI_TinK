...
import App, { CaregiverDashboard } from "./App";
import "./styles.css";
...
const bypassAuthForLocalDevelopment = import.meta.env.DEV && import.meta.env.VITE_DEV_BYPASS_AUTH === "true";

if (bypassAuthForLocalDevelopment) {
  root.render(
    <StrictMode>
      <CaregiverDashboard auth={{ isAuthenticated: true, isLoading: false, user: { name: "local development user" } }} />
    </StrictMode>,
  );
} else if (!domain || !clientId || !audience) {
